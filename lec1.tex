...
\begin{problem} \textbf{(Tavla).}
 Vi vill hänga en tavla med ett snöre (vars ändar är i tavlan) på två spikar. Tillskillnad från vanligt, vill vi att om man tar bort någon spik (oavsett vilken) så ska tavlan ramla! Hur gör vi detta? % TODO Add picture
\end{problem}
